...
searched_tweets = api.search(q=phrase)
list_of_htmls = []
first_base_url = "https://www.si.umich.edu/directory?field_person_firstname_value=&field_person_lastname_value=&rid=All"
final_base_url = "https://www.si.umich.edu/directory?field_person_firstname_value=&field_person_lastname_value=&rid=All&Page=11"
...
def find_urls(str):
	# phrase = r"(http:\/\/|https:\/\/)([A-Za-z0-9]+)(\.)([A-Za-z0-9]+)(.)(\w+)"
...
for i in range(0, 12):
	...
	for person in people:
		...
		umsi_titles[name] = title
			# print (" ************* PRINT PEOPLE *********")
			# for p in people:
			# 	name = p.find("div", {"properrty":"dc:title"})
			# 	print("\n ******** Print the NAME ********")
			# 	print (name.text)
			# 	title = p.find("div", {"class":"field-name-field-person-titles"})
			# 	print("\n ******** Print the title ********")
			# 	print (title.text)
